...
$id = $form['id'];
  ...
  if(isset($form['todelete'])) {
    $sql = "DELETE FROM `household_after` WHERE id='$id';";
    ...
    $sql = "update household_after set relationship='$relationship',
...
$sql = "INSERT INTO `household_after` (`relationship`, `age`, `sex`, `date`,
